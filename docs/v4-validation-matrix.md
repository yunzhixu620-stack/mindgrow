...
| S2.5 canonical ID + 真 createdAt | 发布中 | PR #41 已合并、PR #42 待合并；Supabase 补齐 V11 字段，API `10.9.2` 修复确定性实体保存并让 health 校验必需字段；真实文章重复导入、canonical ID/时间、刷新持久化已通过，待临时数据清理与最终合并 |
