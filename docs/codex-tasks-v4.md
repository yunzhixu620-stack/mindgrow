...
> 状态：等待 Owner 确认。Owner 明确回复“开工”前，只允许评审和修改本任务书，不允许修改产品代码、数据库、云函数或部署配置。
>
...
P2.0.1 精确匹配与集中导出
        ↓
├─ P2.0.2 / P2.0.3 / P2.0.4
├─ P2.1.1 / P2.1.2 / P2.1.3 / P2.1.5 / P2.1.6
└─ P3.0.1 /health warm
        ↓
P3.0.2 骨架屏 + U3
        ↓
...
| 文件 | 任务 | 约束 |
|---|---|---|
| fc-proxy/index.js | P0.1、P0.2、P2.0、P2.1 | 按主顺序串行 rebase；P2.1 至少等待 P2.0.1 |
| src/app/page.tsx | P1.1、P1.3、P3.0.2、U9、U10 | 严格串行 |
| mind-map-panel.tsx | P3.0.2、P2.1.4、U7 | P3.0.2 → P2.1.4 → U7 |
| universe-view.tsx | P1.1.2、P2.1.4、U7 | P1.1.2 → P2.1.4 → U7 |
| article-parser.tsx / meeting-assistant.tsx | P2.0.3/U6 | 同一个 PR |
...
| S2.10 | 观测/on-call | git_sha、部署断言、错误分级、值班 runbook |
...
开工后先确认当前分支、提交、工作区和线上 health，再从 P0.0.1 开始。
