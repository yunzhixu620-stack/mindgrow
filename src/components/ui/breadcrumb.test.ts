...
const maps: MindMap[] = [
  { id: "knowledge", name: "个人知识库", description: "", color: "#22d3a7", isDefault: true, categoryId: null, nodeCount: 3, createdAt, updatedAt: createdAt },
  { id: "meeting", name: "会议知识库", description: "[MindGrow:meeting]", color: "#38bdf8", isDefault: false, categoryId: null, nodeCount: 2, createdAt, updatedAt: createdAt },
  { id: "article", name: "文章知识库", description: "[MindGrow:article]", color: "#a78bfa", isDefault: false, categoryId: null, nodeCount: 4, createdAt, updatedAt: createdAt },
];
